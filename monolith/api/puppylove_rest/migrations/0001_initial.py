# Generated by Django 4.0.3 on 2022-08-23 22:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=1000)),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='owner', to='puppylove_rest.owner')),
            ],
        ),
    ]
